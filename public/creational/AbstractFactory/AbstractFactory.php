...
echo "Клиент: тестирование клиентского кода с первым заводским типом: <br>";
clientCode(new ConcreteFactory1);

echo "<br>";

echo "Клиент: тестирование клиентского кода со вторым заводским типом: <br>";
