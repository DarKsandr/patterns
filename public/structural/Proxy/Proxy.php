...
class RealSubject implements Subject
{
    public function request(): void
    {
        echo "RealSubject: Обработка запроса.<br>";
    }
}
...
class Proxy implements Subject
{
    ...
    private function checkAccess(): bool
    {
        ...
        echo "Proxy: Проверка доступа перед запуском реального запроса.<br>";
    ...
    {
        echo "Proxy: Регистрация времени запроса.<br>";
    }
}
...
echo "Клиент: выполнение клиентского кода с реальным субъектом:<br>";
$realSubject = new RealSubject();
clientCode($realSubject);

echo "<br>";

echo "Клиент: выполнение того же клиентского кода с прокси:<br>";
